 ...
 * BCA Virtual Account by XenInvoice
 *
 ...
 * @return array
 */
function xendit_bca_MetaData()
{
    return array(
        'DisplayName' => 'Xendit BCA Virtual Account Payment Gateway Module',
...
function xendit_bca_config()
{
    return array(
        ...
        'FriendlyName' => array(
            'Type'  => 'System',
            'Value' => 'Xendit BCA Virtual Account',
        ),
 ...
 * @return string
 */
function xendit_bca_link($params)
{
    // System parameters
