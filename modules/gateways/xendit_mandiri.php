 ...
 * Mandiri Virtual Account by XenInvoice
 *
 ...
 * @return array
 */
function xendit_mandiri_MetaData()
{
    return array(
        'DisplayName' => 'Xendit Mandiri Virtual Account Payment Gateway Module',
 ...
 * @return array
 */
function xendit_mandiri_config()
{
    return array(
        ...
        'FriendlyName' => array(
            'Type'  => 'System',
            'Value' => 'Xendit Mandiri Virtual Account',
        ),
 ...
 * @return string
 */
function xendit_mandiri_link($params)
{
    // System parameters
    ...
    if(isset($_POST['payurlgenerator']) || !empty($_POST['payurlgenerator'])) {
        ...
        $img         = $systemUrl . "/modules/gateways/xendit-images/mandiri.png"; 
