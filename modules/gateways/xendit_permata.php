 ...
 * PermataBank Virtual Account by XenInvoice
 *
 ...
 * @return array
 */
function xendit_permata_MetaData()
{
    return array(
        'DisplayName' => 'Xendit Permata Virtual Account Payment Gateway Module',
 ...
 * @return array
 */
function xendit_permata_config()
{
    return array(
        ...
        'FriendlyName' => array(
            'Type'  => 'System',
            'Value' => 'Xendit Permata Virtual Account',
        ),
 ...
 * @return string
 */
function xendit_permata_link($params)
{
    // System parameters
    ...
    if(isset($_POST['payurlgenerator']) || !empty($_POST['payurlgenerator'])) {
        ...
        $img         = $systemUrl . "/modules/gateways/xendit-images/permata.png"; 
